...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Management.results_actioned'
        db.add_column(u'walkin_management', 'results_actioned',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Management.results_actioned'
        db.delete_column(u'walkin_management', 'results_actioned')
    ...
    models = {
        ...
        u'walkin.management': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'results_actioned': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
