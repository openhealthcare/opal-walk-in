...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClinicalFinding.other_findings'
        db.add_column(u'walkin_clinicalfinding', 'other_findings',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClinicalFinding.other_findings'
        db.delete_column(u'walkin_clinicalfinding', 'other_findings')
