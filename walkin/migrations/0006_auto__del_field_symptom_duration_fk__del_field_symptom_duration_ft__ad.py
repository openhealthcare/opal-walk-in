...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Symptom.duration_fk'
        db.delete_column(u'walkin_symptom', 'duration_fk_id')

        # Deleting field 'Symptom.duration_ft'
        db.delete_column(u'walkin_symptom', 'duration_ft')

        # Adding field 'Symptom.duration'
        db.add_column(u'walkin_symptom', 'duration',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Symptom.duration_fk'
        db.add_column(u'walkin_symptom', 'duration_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Duration'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Symptom.duration_ft'
        db.add_column(u'walkin_symptom', 'duration_ft',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Symptom.duration'
        db.delete_column(u'walkin_symptom', 'duration')
